...
# Para mejorar la visualizacion de los datos, le estamos aplicando un factor para q se vea mas claro
data2 = log2(data)
...
#el de col era para diferenciar entre los WT y los KO con distintos colores, main es el titulo y las=2 es 
#para que salgan los titulos en vertical
# ¿Qué es un boxplot?
#Un grafico que muestra los cuartiles, q1, q2, q3, los valores minimos y maximos que no son atipicos y los outliers
...
# Si, porque los 3 WT estan agrupados y los 3 de KO estan agrupados
...
head(pvalue)
#Usamos datos sin transformar para evitar sesgos y ver los datos brutos
#Cada muestra tiene el numero de genes de valores, osea 12488
...
#Podemos visualizar mejor el histograma, ya que transforma los datos
...
dim(filtered)
head(filtered)
# ¿Cuántos genes cumplen los dos criterios? 426
...
#¿Por qué parece que están al revés? Porque la sobreexpresion estan marcados con valores positivos y los reprimidos con negativos, por una decision que tomamos al principio. 
...
heatmap(filtered)
# ¿Qué es cada parámetro que hemos usado dentro de la función heatmap? Los genes diferencialmente expresados 
